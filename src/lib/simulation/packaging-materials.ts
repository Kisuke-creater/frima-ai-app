...
export const PACKAGING_MATERIALS: PackagingMaterial[] = [
  { id: "none", label: "手持ち資材を使う", cost: 0 },
  { id: "envelope_small", label: "小型封筒", cost: 30 },
  ...
  { id: "box_60_generic", label: "60サイズ箱", cost: 120 },
  { id: "box_80_generic", label: "80サイズ箱", cost: 160 },
  { id: "box_100_generic", label: "100サイズ箱", cost: 220 },
  { id: "box_120_generic", label: "120サイズ箱", cost: 250 },
  { id: "box_140_generic", label: "140サイズ箱", cost: 350 },
  { id: "box_160_generic", label: "160サイズ箱", cost: 500 },
];

export const PACKAGING_MATERIAL_MAP = Object.fromEntries(
  PACKAGING_MATERIALS.map((material) => [material.id, material]),
) as Record<string, PackagingMaterial>;
